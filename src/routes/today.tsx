  ...
  return (
    ...
    >
      <div
        ...
        className="w-full sm:max-w-md max-h-[92vh] overflow-y-auto bg-card border border-border rounded-t-3xl sm:rounded-3xl shadow-xl"
        style={{ paddingBottom: "env(safe-area-inset-bottom, 0px)" }}
      >
        <header className="sticky top-0 z-10 flex items-center gap-3 px-5 py-4 border-b border-border bg-card/95 backdrop-blur">
        ...
        <div className="px-5 py-5 space-y-4">
          ...
          <div className="rounded-2xl border border-border bg-background/60 p-4">
            ...
            <input
              ...
              className="mt-3 w-full rounded-full bg-card border border-border px-4 py-2.5 text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            />
            {newExercise.trim() && (
              <div className="mt-3">
                <AddSetForm
    ...
    <section className="rounded-2xl border border-border bg-background/60 p-4">
      <div className="flex items-baseline justify-between gap-2">
        ...
        {ex.last && (
          <span className="text-[11px] tabular text-muted-foreground shrink-0">
            Last time: {ex.last.weight_kg}kg × {ex.last.reps}
          </span>
        )}
      </div>
      {ex.sets.length > 0 && (
      ...
      {adding ? (
        ...
        <button
          ...
          className="mt-3 inline-flex items-center gap-1.5 rounded-full border border-border px-3 py-2 text-[13px] text-foreground hover:bg-muted"
        >
  ...
  return (
    <label className="flex flex-col gap-1">
      ...
      <input
        ...
        className="w-24 h-12 rounded-xl bg-background border border-border px-3 text-base tabular text-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
      />
    </label>
  );
}
