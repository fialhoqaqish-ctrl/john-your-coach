...
const VERDICT_COLOR: Record<string, string> = {
  ...
  HOLDING: "var(--color-muted-foreground)",
  SLIPPING: "var(--color-warning)",
  BUILDING: "var(--color-muted-foreground)",
};
...
function FitnessHero({ d }: { d: Dashboard }) {
  ...
  return (
    <section className="pt-2">
      ...
      <Verdict>
        {d.fitness_verdict?.subline ?? "Reading your easy-effort pace — verdict firms up as runs land."}
